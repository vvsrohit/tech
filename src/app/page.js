      ...
      <div className="page-root min-h-screen font-sans bg-gray-50 dark:bg-black text-slate-900 dark:text-slate-100">
        ...
        <main className="container mx-auto px-6 py-12">
          <section className="hero grid gap-8 md:grid-cols-2 items-center">
            <div>
              {/* Animated heading */}
              <h1 className="text-4xl md:text-5xl font-extrabold leading-tight fade-up">
                IEEE Dholakpur — Build the future
              </h1>

              {/* Animated subheading */}
              <p className="mt-4 text-lg text-slate-600 dark:text-slate-300 max-w-xl fade-up delay-1">
              ...
              {/* Animated buttons */}
              <div className="mt-6 flex gap-3 fade-up delay-2">
                <a
                  id="register"
                  href="#"
